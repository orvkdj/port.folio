...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to nelsonlai.dev.
...
- **Website** refers to nelsonlai.dev, accessible from [https://nelsonlai.dev](https://nelsonlai.dev)
...
You represent that you are over the age of 18. If You are under 18, You must have a parent or guardian be representative of You in order to use the service. The company does not permit those under 13 years of age to use the Service.
