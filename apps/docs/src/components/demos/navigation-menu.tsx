        ...
        <NavigationMenuItem className='hidden md:block'>
          ...
          <NavigationMenuContent>
            <ul className='grid w-[200px] gap-4'>
              <li>
                <NavigationMenuLink asChild>
                  <Link href='/backlog' className='flex-row items-center gap-2'>
                    <CircleHelpIcon />
                    Backlog
                  </Link>
                </NavigationMenuLink>
                <NavigationMenuLink asChild>
                  <Link href='/todo' className='flex-row items-center gap-2'>
                    <CircleIcon />
                    To Do
                  </Link>
                </NavigationMenuLink>
                <NavigationMenuLink asChild>
                  <Link href='/done' className='flex-row items-center gap-2'>
                    <CircleCheckIcon />
                    Done
                  </Link>
                </NavigationMenuLink>
